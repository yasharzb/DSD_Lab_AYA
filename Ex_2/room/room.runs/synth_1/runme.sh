...
HD_PWD='C:/Users/Yasharzb/Documents/GitHub/DSD_Lab_AYA/Ex_2/room/room.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log room_man.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source room_man.tcl
