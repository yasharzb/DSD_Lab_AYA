...
HD_PWD='C:/Users/Yasharzb/Documents/GitHub/DSD_Lab_AYA/Ex_2/room/room.runs/counter_4_or_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_4_or_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_4_or_0_1.tcl
