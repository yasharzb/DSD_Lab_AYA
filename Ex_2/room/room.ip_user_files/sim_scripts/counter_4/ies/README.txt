...
#
# Generated by export_simulation on Mon Oct 26 12:01:42 +0330 2020
#
################################################################################
...
'-reset_run' switch to the './counter_4.sh' script.

./counter_4.sh -reset_run
...
./counter_4.sh -noclean_files

For more information on the script, please type './counter_4.sh -help'.
