...
#
# Generated by Vivado on Mon Oct 26 10:39:39 +0330 2020
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L util_vector_logic_v2_0_1 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot counter_4 xil_defaultlib.counter_4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim counter_4 -key {Behavioral:sim_1:Functional:counter_4} -tclbatch cmd.tcl -protoinst "protoinst_files/counter_4.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb counter_4.wdb xsim.dir)
