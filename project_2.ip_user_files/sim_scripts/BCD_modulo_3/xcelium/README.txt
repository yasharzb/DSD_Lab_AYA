...
#
# Generated by export_simulation on Tue Oct 20 18:58:47 +0330 2020
#
################################################################################
...
'-reset_run' switch to the './BCD_modulo_3.sh' script.

./BCD_modulo_3.sh -reset_run
...
./BCD_modulo_3.sh -noclean_files

For more information on the script, please type './BCD_modulo_3.sh -help'.
