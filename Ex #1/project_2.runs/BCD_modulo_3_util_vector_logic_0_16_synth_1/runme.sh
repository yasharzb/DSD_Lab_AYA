...
HD_PWD='C:/Users/Yasharzb/Documents/GitHub/DSD_Lab_AYA/project_2.runs/BCD_modulo_3_util_vector_logic_0_16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_modulo_3_util_vector_logic_0_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_modulo_3_util_vector_logic_0_16.tcl
